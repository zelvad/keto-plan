...
Route::middleware('guest')->group(function () {
    ...
    Route::view('fitoplan-subscriber', 'client.auth.ketoplan-subscribe');
    Route::view('fitoplan-subscribe', 'client.auth.ketoplan-subscribe-not');
